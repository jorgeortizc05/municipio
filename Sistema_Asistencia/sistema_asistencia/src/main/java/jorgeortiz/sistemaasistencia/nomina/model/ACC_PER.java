...
public class ACC_PER implements Serializable {
	...
	public String toString() {
		return "ACC_PER [CODIGO=" + CODIGO + ", FECHA_EXPEDICION=" + FECHA_EXPEDICION + ", ACCION=" + ACCION
				+ ", FECHA_VIGENCIA=" + FECHA_VIGENCIA + ", EXPLICACION=" + EXPLICACION + ", PUESTO_ACTUAL="
				+ PUESTO_ACTUAL + ", SUELDO_ACTUAL=" + SUELDO_ACTUAL + ", FECHA_SOLICITUD=" + FECHA_SOLICITUD
				+ ", OFICIO_SOLICITUD=" + OFICIO_SOLICITUD + ", REGISTRO=" + REGISTRO + ", USUARIO=" + USUARIO
				+ ", INSUBSISTENTE=" + INSUBSISTENTE + ", ACT_CARG_CODIGO=" + ACT_CARG_CODIGO + ", SER_CODIGO="
				+ SER_CODIGO + ", ACT_CARG_L_T_CODIGO=" + ACT_CARG_L_T_CODIGO + ", ACT_CARG_L_T_PROG_CODIGO="
				+ ACT_CARG_L_T_PROG_CODIGO + ", ACT_CARG_L_T_PROG_FUN_CODIGO=" + ACT_CARG_L_T_PROG_FUN_CODIGO
				+ ", CREATED_BY=" + CREATED_BY + ", CREATION_DATE=" + CREATION_DATE + ", LAST_UPDATED_BY="
				+ LAST_UPDATED_BY + ", LAST_UPDATE_DATE=" + LAST_UPDATE_DATE + ", PARTIDA=" + PARTIDA + ", DIRECCION="
				+ DIRECCION + ", FECHA_TERMINO=" + FECHA_TERMINO + ", ID_ACC_PER=" + ID_ACC_PER + "]";
	}
